                        ...
                        <?php
                            ...
                            if(count($hotel_images) > 0) {
                                ...
                                foreach($hotel_images as $hotel_image) {
                                    ...
                                    if ($imgno % 7 === 0) {                                        
                                        echo '<div class="galleryGrid__item position-relative '.$imgno.'">
                                            <a href="'.$hotel_image->img.'" data-lightbox="roadtrip"><img src="'.$hotel_image->img.'" alt="image" class="rounded-2 img-fluid"></a>
                                            <div class="position-absolute end-0 bottom-0 mb-3 me-3">
                                                <a href="'.$hotel_image->img.'" data-lightbox="roadtrip"
                                        ...
                                        echo '<div class="galleryGrid__item '.$cuscss.' '.$imgbox.'">
                                        <a href="'.$hotel_image->img.'" data-lightbox="roadtrip"><img src="'.$hotel_image->img.'" alt="image" class="rounded-2 img-fluid"></a>
                                    </div>';
                                    }
                                }
