                        ...
                        <div class="d-flex align-items-center justify-content-center flex-column mb-4">
                            <div class="border br-dashed full-width rounded-2 p-3 pt-0">
                                <ul class="row align-items-center justify-content-start g-3 m-0 p-0">
                                    <li class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                                        <div class="d-block">
                                            <p class="text-dark fw-medium lh-2 mb-0">Travel Number</p>
                                            <p class="text-muted mb-0 lh-2">#<?= $travel_number ?></p>
                                        </div>
                                    </li>
                                    <li class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                                        <div class="d-block">
                                    ...
                                    <li class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                                        <div class="d-block">
                                            <p class="text-dark fw-medium lh-2 mb-0">No of Passengers</p>
                                            <p class="text-muted mb-0 lh-2"><?= $passengers ?></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $n =1;
                                    foreach($passengerlists as $passenger) {
                                        echo '<tr>
                                            <th>'.$n.'</th>
