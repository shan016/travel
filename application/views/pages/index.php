    ...
    <div class="container">
        ...
        <div class="row justify-content-center gy-4 gx-3">
            ...
            foreach($regions as $region) {
                echo '<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
                    <div class="destination-blocks-pics p-1">
                        <a href="'.base_url('destination/'.$region->id).'"><img src="'.$this->config->config['asset_url'].'assets/img/city/'.$region->region_img.'" class="img-fluid rounded" alt=""></a>
                    </div>
        ...
        <div class="row justify-content-center gy-4 gx-xl-4 gx-lg-3 gx-md-4 gx-4">
            ...
            foreach($service_hotels as $shotel) {
                ...
                <div class="pop-touritem">
                    <a href="qqq'.base_url('destination/'.$shotel->ID).'" class="card rounded-3 border m-0">
                ...
                <div class="pop-touritem">
                    <a href="#" class="card rounded-3 border br-dashed m-0">
                        <div class="flight-thumb-wrapper p-2 pb-0">
                            <div class="popFlights-item-overHidden rounded-3 image-container">
                                <img src="' . $transportation->image . '" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="touritem-middle position-relative p-3">
                            <div class="touritem-flexxer">
                                <div class="explot">
                                    <h4 class="city fs-6 m-0 fw-bold">
                                        <span>' . $transportation->transportation_compneis_name . '</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="main-carousel cols-4 dots-full">
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/piT6JF9Wjpg1.jpg" class="img-fluid object-fit" alt="image">
                            </div>
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/98DhqOKZjpg1.jpg" class="img-fluid object-fit" alt="image">
                            </div>
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/SmIODhE8jpg.jpg" class="img-fluid object-fit" alt="image">
                            </div>
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/j4gdsVMIjpg1.jpg" class="img-fluid object-fit" alt="image">
                            </div>
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/DHEdeNrsjpg1.jpg" class="img-fluid object-fit" alt="image">
                            </div>
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/LV5B081djpg1.jpg" class="img-fluid object-fit" alt="image">
                            </div>
                    ...
                    <div class="carousel-cell">
                        <div class="cardCities cursor rounded-2">
                            <div class="cardCities-image ratio ratio-4">
                                <img src="https://daleelcom.net/imgs/ads-images/n197GMhEjpg1.jpg" class="img-fluid object-fit" alt="image">
                            </div>
