                        ...
                        foreach ($models as $model) {
                            ...
                            if(!empty($goingfrom)) {
                                $btnbook = '<div class="flight-button-wrap">
                                            <a href="'.base_url('flight/detailspayment/'.$model->schdual_id).'?goingfrom='.$goingfrom.'&goingto='.$goingto.'&departure='.$departure.'&datereturn='.$datereturn.'&occupant='.$occupant.'" class="btn btn-primary btn-md fw-medium full-width">Select<i class="fa-solid fa-arrow-trend-up ms-2"></i></a>
                                        </div>';
